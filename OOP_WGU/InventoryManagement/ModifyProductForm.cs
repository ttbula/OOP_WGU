...
namespace InventoryManagement
{
   public partial class ModifyProductForm : Form
   {
      ...
      public ModifyProductForm(Product original)
      {
         _original = original;
         InitializeComponent();
         this.AcceptButton = btnSave;

         txtboxID.Text = original.ProductID.ToString();
         ...
         _workingAssociated = new BindingList<Part>(_original.AssociatedParts.ToList());
         dgvAssociatedParts.DataSource = _workingAssociated;
      ...
      private BindingList<Part> _workingAssociated = new BindingList<Part>();
      private class ModifiedProductInput
      {
      ...
      private void SetProductInput(ModifiedProductInput input)
      {
      ...
      /// </summary>
      private bool IsFormValid(out ModifiedProductInput input, out string errorMessage)
      {
         input = new ModifiedProductInput();
      ...
      {
         if (_workingAssociated == null || _workingAssociated.Count == 0)
         {
      ...
      private void btnDelete_Click(object sender, EventArgs e)
      {
         ...
         {
            _workingAssociated.Remove(selectedPart);
         }
      }
